...
if __name__ == "__main__":
    ...
    set_data_directory("spillover_simulation_debug_scratch")
    spillover_experiment(species_to_withhold = 'SARS_CoV_2', validate_model=True, model_initializer = make_CNN, confidence_threshold=0.99)
